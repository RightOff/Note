...
yolov8n.pt，参数量3.06$*10^6$，计算量8.1GFLOPs，权重文件6.2M

![1706688712487](image/实验记录/1706688712487.png)

#### C2f_DAttention + small_Object_yolov81

C2f_DAttention + small_Object_yolov8.pt，参数量3.04$*10^6$，计算量12.7GFLOPs，权重文件6.5M

![1706688916558](image/实验记录/1706688916558.png)
